...
class ClothoidSpline {
	...
	public:
        ...
        ClothoidSpline(const vector <Vector> & edgePoints, float penalty=DEFAULT_CLOTHOID_PENALTY,
	...
	void setupFineSamples(float sampleDistance);
        ...
        void getCurvatures(const vector <Vector> & theEdgePointSet, vector <float> & curvVec);
